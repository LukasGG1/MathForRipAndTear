...
It is not much gameplay or feature. Just one or two.

Goal
If Player reaches goal, you win. then, press to esc.


====================================================

My another project called RPGStuff.
 also, It is still in progress.
 Because I had added more and more image.
 However, It is not same MathLiberay as MathForTearAndRip.

Yet, I'm trying figure out how to make building enterance as colliuison.
 If player touches colliuison and text will show up.
 If You press which input and it takes you to room as another scene.